...
public class SwaggerConfig {
	...
	public Docket api() {
		return new Docket(DocumentationType.SWAGGER_2)				
				...
				.select()
				.apis(RequestHandlerSelectors.basePackage("com.reiras.localidademicroservice.controller"))
	...
	private ApiInfo apiInfo() {
		return new ApiInfo(
				"Localidades",
				"Microservice to retry Brazilian locations based on external API",
				"Version 1.0",
				"https://github.com/reirasdev/localidade-microservice",
